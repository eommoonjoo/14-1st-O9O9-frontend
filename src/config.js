...
//메인 카테고리 목록 api 주소
export const MAINCATEGORY_PRODUCTS_DATA_API =
  'http://172.30.1.29:8000/products/categories';
...
export const USERINFO_API = 'http://10.58.4.236:8000/user/name';

//로그인 api 주소
export const LOGIN_API = 'http://10.58.4.236:8000/user/signin';

//장바구니 목록 받아오는 api 주소
export const CARTLIST_API = 'http://10.58.2.26:8000/order/';
...
//상품 목록 받아오는 api 주소
export const CATEGORIES_API = 'http://172.30.1.29:8000/products';
...
export const PRODUCT_DETAIL_API = 'http://10.58.6.68:8000/products';

// 승제님 qna list api
export const PRODUCT_QNALIST_API = 'http://10.58.4.236:8000/review/question';
// 승제님 qna modal api
