...
export const MAINCATEGORY_PRODUCTS_DATA_API =
  `http://192.168.0.10:8000/products/categories`;

export const PRODUCTS_LIST_API = `http://192.168.0.10:8000/products`;
...
export const CATEGORIES_API = 'http://192.168.0.10:8000/products';
...
export const PRODUCT_DETAIL_API = 'http://192.168.0.10:8000/products';
...
// 로그인 유효성검사 API
export const LOGIN_CHECK_VALIDATION_API = `http://192.168.0.10:8000/user/signin`;
// 승제님 qna enroll api
export const QUESTION_ENROLL_API =
  `http://${IP_ADDRESS}:8000/review/questionenroll`;
